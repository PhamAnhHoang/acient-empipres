...
public class GameCreateScreen extends Screen implements GameCreatorListener {
	...
	public void initComponents() {
		...
		//menu to choose map
		btn_back.setBounds(width/2, height-ts/2, width/6, ts/2);
		...
		this.add(btn_back);
		btn_play.setBounds(btn_back.getWidth()+width/2, height-ts/2, width/6, ts/2);
		...
		this.add(btn_play);
		btn_preview.setBounds(width/2+btn_play.getWidth()*2, height - ts/2, width/6, ts/2);
